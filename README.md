...
### **5.จากนั้นจะแสดงหน้าจอเกี่ยวกับการยอมรับสิทธิ์ ให้เรากดปุ่มดังภาพเพื่อยอมรับการติดตั้ง**
...
### **9.หลังจากติดตั้งเสร็จให้กดปุ่ม next**
...
### **Google colab นั้นสามารถใช้เขียน python บนเว็บบราวเซอร์ได้ฟรี โดยไม่จำเป็นต้องติดตั้งโปรแกรม โดยแนะนำให้เขียนผ่านเว็บบราวเซอร์ของ Google chrome โดยจะมีขึ้นตอนการใช้งานดังนี้**
...
### **จะปรากฏเว็บบราวเซอร์ดังภาพและสามารถใช้งานการเขียน python ได้เลย**
...
### **4.ทำการติดตั้ง git บน Anaconda โดยการเปิดเว็บบราวเซอร์แล้วพิมพ์anaconda install git แล้วคลิก [ Git :: Anaconda Cloud](https://anaconda.org/anaconda/git)**
...
### **8.ทำการเชื่อมต่อไฟล์กับโปรเจคใน github โดยการพิมพ์คำสั่ง 'git clone' เว้นวรรคแล้วตามด้วยลิงค์ที่ก็อปมาจาก clone or download ในข้อที่6และเมื่อเคยทำการ git clone แล้วจะเป็นดังภาพและคำสั่งนี้ใช้เพียงครั้งเดียวเมื่อเริ่มโปรเจค**
